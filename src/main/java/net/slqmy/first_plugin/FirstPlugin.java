...
import net.slqmy.first_plugin.events.EventListener;
import net.slqmy.first_plugin.tab_completers.FruitTabCompleter;
import org.bukkit.*;
...
public final class FirstPlugin extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		if (!success) {
			System.out.println(Utility.getLogPrefix() + "Failed to create plugin data folder! Quitting plugin startup.");
			return;
		}
		...
		Bukkit.getPluginManager().registerEvents(new EventListener(this, bossBar, recentMessages), this);

		// If plugin doesn't support Maven, then add it by going to file => project structure => libraries.
		WorldEdit worldEdit = WorldEdit.getInstance();
		System.out.println("WorldEdit API is working?: " + (worldEdit != null));
