package dev.enderman.minecraft.plugins.first.utility.types;
...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
	 ...
	 * This
	 * version of getRelativeBlock() should be used if being called many times, to
	 * avoid
